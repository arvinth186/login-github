        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateDetailsForm">
                    ...
                    <button type="submit" class="btn btn-primary"data-bs-dismiss="modal" data-bs-toggle="modal" id="saveButton">Save</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                $logQuery = "SELECT username, name, email, dob, phone_number, age, address FROM logs WHERE username = ?";
